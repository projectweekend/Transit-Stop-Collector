...
var asyncError = require( "../utils" ).asyncError;
var asyncSuccess = require( "../utils" ).asyncSuccess;
    ...
    return function ( done ) {
        ...
        var parseStopInfo = function ( line ) {
            ...
            var stop = {
                ...
                direction: directionMatch !== null ? directionMatch[ 0 ].toLowerCase() : ""
            };
        ...
        csvStream.on( "error", asyncError( done ) );
        csvStream.on( "end", asyncSuccess( done ) );
...
var connectToDatabase = function ( done ) {
...
var refreshStopsData = function ( done ) {

    TransitStop.removeChicagoCTA( function ( err ) {
        ...
        TransitStop.insertBulk( DOCUMENTS, function ( err ) {
